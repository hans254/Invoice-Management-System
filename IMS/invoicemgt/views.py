...
def list_invoice(request):
    ...
    if form['generate_invoice'].value() == True:
        ...
        message = str(num_of_invoices) + 'Invoice Successfully Generated.'
        ...
        def import_data(data_file):
            ...
            for row in invoice_data:
                ...
                str(line_one), str(line_one_quantity), str(line_one_unit_price), str(line_one_total_price),
                ...
                def generate_invoice(
                    ...
                    #image of seal
                    c.drawImage('seal.png', 50, 700, width=500, height=120)
                    ...
                    c.setFont('Helvetica', 12, leading=None)
                    c.drawCentredString(492, 641, str(invoice_date))
                    c.setFont('Helvetica', 12, leading=None)
                    ...
                    c.setFont('Helvetica', 12, leading=None)
                    c.drawCentredString(156, 660, name)
                    c.setFont('Helvetica', 12, leading=None)
                    c.drawCentredString(98, 640, 'Phone:')
                    c.setFont('Helvetica', 12, leading=None)
                    c.drawCentredString(156, 640, phone_number)
                    c.setFont('Helvetica-Bold', 14, leading=None)
                    c.drawCentredString(316, 580, str(invoice_type))
                    c.drawCentredString(110, 560, 'Particulars:')
                    c.drawCentredString(295, 510, '________________')
                    c.drawCentredString(295, 480, '_________________')
                    c.drawCentredString(295, 450, '_________________')
                    c.drawCentredString(295, 420, '_________________')
                    c.drawCentredString(295, 390, '_________________')
                    c.drawCentredString(295, 360, '_________________')
                    c.drawCentredString(295, 330, '_________________')
                    c.drawCentredString(295, 300, '_________________')
                    c.drawCentredString(295, 270, '_________________')
                    c.drawCentredString(295, 240, '_________________')
                    c.drawCentredString(295, 210, '_________________')
                    c.setFont('Helvetica-Bold', 12, leading=None)
                    ...
                    if line_three!= '':
                        ...
                        #SIGN
                        c.setFont('Helvetica-Bold', 12, leading=None)
                        c.drawCentredString(150, 120, 'Signed:__________________')
                        c.setFont('Helvetica-Bold', 12, leading=None)
                        c.drawCentredString(150, 100, 'Date:____________________')
                        c.setFont('Helvetica-Bold', 12, leading=None)
                        c.drawCentredString(150, 80, 'Manager')
                        c.showPage()
                        print('writing')
