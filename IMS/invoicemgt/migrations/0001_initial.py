    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('line_one_total_price', models.IntegerField(blank=True, default=0, null=True, verbose_name='Line Total')),
                ...
                ('invoice_type', models.CharField(blank=True, choices=[('Invoice', 'Invoice'), ('Credit Note', 'Credit Note'), ('Debit Note', 'Debit Note'), ('Receipt', 'Receipt'), ('Proforma Invoice', 'Proforma Invoice')], default='', max_length=120, null=True)),
            ],
        ),
    ]
